...
const UserForms = () => {
  ...
  // const [progressBtn, setProgressBtn] = useState(['step1', 'step2', 'step3']);
  ...
  //   // if (!isLastStep && isFirstStep || (currentStepIndex === 1)) {
  //   if (isLastStep && step1) {
  //     stepBack();
  //     stepBack();
  //   } else if (isLastStep && step2) {
  //     stepBack();
  //   } else if (isFirstStep && step2) {
  //     handleContinue();
  //   } else if ((isFirstStep || currentStepIndex === 1) && step3) {
  //     handleContinue();
  //   }
  // };
            ...
            <section className="h-full w-full flex-col">
                ...
                <form onSubmit={handleSubmit} className='h-full min-h-[85%] flex flex-col gap-3'>
                    ...
                    <div className="flex items-center gap-1">
                        {/* <ButtonNeutral id={progressBtn[0]} onClick={progressBarNavigation} classes='h-1 flex-1 bg-primary rounded-md' />
                        <ButtonNeutral id={progressBtn[1]} onClick={progressBarNavigation} classes={`${currentStepIndex === 1 || currentStepIndex > 1 ? 'bg-primary' : 'bg-customGray'} h-1 flex-1 rounded-md`} />
                        <ButtonNeutral id={progressBtn[2]} onClick={progressBarNavigation} classes={`${currentStepIndex === 2 ? 'bg-primary' : 'bg-customGray'} h-1 flex-1 rounded-md`} /> */}
