  ...
  return (
    <>
      ...
      <header className="bennetCurve text-white bg-zinc-50 xl:h-70vh mb-6 px-2 md:px-6">
        <div className="relative text-white bg-theme mb-14 py-6 md:py-auto px-1 md:px-4 h-full rounded-lg flex flex-col lg:flex-row items-center justify-between" style={{ backgroundImage: `url('/images/bgHeader.jpeg')` }}>
          
          <div className='bg-[#064f38] absolute inset-0 bg-opacity-95 rounded-lg'></div>
