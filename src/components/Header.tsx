    ...
    <>
      ...
      <header className="bennetCurve text-white bg-zinc-50 xl:h-[70vh] mb-6 px-2 md:px-6">
        <div className="relative text-white bg-primary mb-14 py-6 md:py-auto px-1 md:px-4 h-full rounded-lg flex flex-col lg:flex-row items-center justify-between" style={{ backgroundImage: `url('/images/bgHeader.jpeg')` }}>
          ...
          <div className='bg-primary absolute inset-0 bg-opacity-95 rounded-lg'></div>
          ...
          <div className="relative z-10 lg:w-2/3 text self-start px-4 md:pl-14 lg:pl-20 text-gray-950">
            ...
            <Button onClick={handleScroll} btnText='Shop now' classes="flex items-center gap-3 bg-secondary hover:bg-secondary_hover mt-4 md:mt-16 mb-4 font-bold rounded-xl text-primary py-[11px] px-[27px] hover:cursor-pointer shadow-md" />
          </div>
