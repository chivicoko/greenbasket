import { CardMembershipOutlined, DeliveryDiningOutlined } from '@mui/icons-material';
            ...
            >
                ...
                <div className="relative z-10 text-white py-3 sm:py-4 md:py-8 px-3 sm:px-6 lg:px-10 flex justify-between">
                    <div className='flex flex-col gap-8 lg:gap-10 w-2/3'>
                        <p className={`${discountCard.badgeBgcolor} py-1 rounded-md w-fit px-3 text-sm`}>{discountCard.icon} {discountCard.badgeText}</p>
