      ...
      <div className="grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8 xl:gap-12">
        {
          discountCard2.map(card => 
            <div key={card.id} className={`rounded-xl h-96 transform transition-transform duration-300 hover:-rotate-3 shadow-md hover:shadow-2xl pt-0 flex-1 flex flex-col gap-4 justify-center items-center  ${card.bgColor1}`}>
