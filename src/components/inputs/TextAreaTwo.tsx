  ...
  return (
    <div className="relative w-full">
      <textarea 
        ...
        onChange={onChange}
        rows={rows}
        className={`block pt-2 px-3 text-base text-black bg-white border border-gray-300 rounded-xl appearance-none focus:outline-none focus:ring-[1px] focus:ring-primary peer ${classes}`}
      ></textarea>
      <label 
        htmlFor={id}
