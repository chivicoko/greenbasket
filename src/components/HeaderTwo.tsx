    ...
    <>
      ...
      <header className=" text-white bg-zinc-50 mb-1 lg:mb-4 px-2 md:px-6">
        <div className="flex gap-3 mt-4 mb-4">
          <button onClick={goBack} className='group flex items-center gap-2 font-bold border-b border-theme text-black pt-[11px] px-1 ml-6 md:ml-16 hover:cursor-pointer'>
