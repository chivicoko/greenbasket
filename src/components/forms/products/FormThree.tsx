  ...
  return (
    <div className='h-[75%] space-y-3 overflow-y-auto custom-scrollbar2 px-1'>
      ...
      <div className="space-y-3 mt-[6px] flex items-center justify-center flex-wrap">
        <InputTwo autoFocus required type='number' value={stock} onChange={e => updateFields({stock: e.target.value})} classes='w-full' floatingLabel='Stock' />
        <InputTwo required type='number' value={price} onChange={e => updateFields({price: e.target.value})} classes='w-full' floatingLabel='Price' />
        <InputTwo required type='number' value={discountPercentage} onChange={e => updateFields({discountPercentage: e.target.value})} classes='w-full' floatingLabel='Discount Percentage' />
